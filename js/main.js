...
jQuery(document).ready(function($) {
    ...
    var pwdv = ["bashy"] // To print pwd 
    var s = []; //Array for directories
    var f = []; //Array for files
    var count = 6; //Required to continue making sub directories
    var o = { "bashy": "0", "Documents": "1", "Downloads": "2", "Music": "3", "Pictures": "4", "Videos": "5" }; //Object to assign array of sub folders to a folder
    ...
    $('body').terminal({
        ...
        cd: function(arg1) {
            ...
            if (e == 1) {
                ...
                pwdv.splice(0, 1);
                var pwdvNew = pwdv.join(',').replace(/,/g, '/').split();
                y = '[[b;#44D544;]bashy@localhost/' + pwdvNew + ':~$]';
                this.set_prompt(y);
                pwdv.unshift("bashy");
            } else if (e == 2) {
                if (x != 0) {
                ...
                if (x != 0) {
                    ...
                    x = 0;
                    pwdv.splice(1);
                    y = '[[b;#44D544;]bashy@localhost/' + pwdv + ':~$] '
                    this.set_prompt(y);
        ...
        contribute: function() {
            ...
            this.echo('> Link: <https://github.com/Shubhankardubey/bashy>\n');
        },
        about: function() {
            ...
            this.echo("> I'm [[b;#44D544;]Shubhankar Dubey], a computer science undergrad at BIET-jhansi.");
            this.echo("> If you wish to know more then head over to my portfolio <https://github.com/Shubhankardubey/bashy>\n");
        },
    }, {
        ...
        prompt: "[[b;#44D544;]bashy@localhost:~$] ",
        greetings: "      All rights reserved © Shubhankar Dubey\n\n" +
